...
<body class="home-body" style="background-color:#ecf0f1;">
     ...
     ?>     
<div class="container">
    <div class="card-group w-100 text-center alert  clearfix" style="margin-top: 100px;background-color: #2d3436;">
              <div class="card w-50  float-left">
                    <div class="card-header " >
                      <img style=" width: 200px ; height: 200px;border-radius: 50%; border:10px solid white" class="card-img" src="../../images/<?php echo $row['post_img'] ?>" alt="Images">
              ...
              <div class="card w-50  float-left">
                    ...
                    <div class="card-footer">
                      <div class="text" style="text-align:left;margin-left: 110px;padding: 30px;">
                        <p class="card-subtitle"><span style="font-weight: bold;"> publisher:</span> <?php echo $row['publisher'] ?></p>
                        <p class="card-text"><span style="font-weight: bold;"> publishing year:</span>  <?php echo $row['publishyear'] ?></p>
                        <p class="card-text"><span style="font-weight: bold;"> subject:</span>  <?php echo $row['subject'] ?></p>
                      </div>
                    </div>
              </div>
    </div>
